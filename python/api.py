...
try:
    ...
    from open_deep_research.graph import graph as research_graph
    from open_deep_research.configuration import Configuration as ResearchConfiguration
except ImportError as e:
    logger.error(f"Failed to import deep research modules: {str(e)}")
    raise
...
try:
    ...
    # Don't raise here, as we might still want to use the deep research functionality
